OperatorRadioLayout.prototype = Object.create(OperatorInteraction.prototype);

function OperatorRadioLayout(v) {
    ...
    this.update = function(slots, currentIdx, nextIndex) {
        ...
        for(i= 0;i<this.group.numberOfSlots;i++) {
            ...
            s.y = this.group.centerXYZ.y + this.offsetY;
