package lemonflow.ui.base {
	...
	public class UIDataGroup implements IUIDataGroup
	{
		//actual rendering surface
		protected var _renderer:GroupRenderer_UIComponent;//= new GroupRenderer_UIComponent(this);
		...
		protected var renderFactory:IFactory;
		...
		public function UIDataGroup() {
			super();
			_dataHandler = new DataAdapter(this);
			_interactionHandler.component = this;
			
			renderer = new GroupRenderer_UIComponent(viewdata);
		}
...
//				}
		...
		public function set continuousUpdates(v:Boolean):void {
			...
			if(v) renderer.addEventListener(Event.ENTER_FRAME, function(e:Event):void { invalidate() } ); 
			else renderer.removeEventListeners(Event.ENTER_FRAME); 
