package lemonflow.ui.operators
{
	 ...
	 */
	public class DendrogramLayout extends OperatorLayout
	{
		...
		{
			init();
			doLayout(group.dataStructure.tree.root);
		}
		...
		{
			var root:VisualNodeItem = group.dataStructure.tree.root;
			_leafCount = group.dataStructure.tree.countLeaves();
			_leafIndex = 0;
		...
		private function computeHeights(n:VisualNodeItem):int
		{
			n.u = 0;
		...
		private function doLayout(n:VisualNodeItem):Number
		{
...
//					layoutEdge(c.parentEdge, bc, d);
		...
		private function layoutNode(n:VisualNodeItem, b:Number, d:Number):void
		{
			var o:Object = n;
